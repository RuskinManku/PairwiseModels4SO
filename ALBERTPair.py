...
def main():
    ...
    if args.dataset=="sind":
        ...
        MODEL_SAVE_NAME="albertpair_sind_model"
    ...
    CHECKPOINT=None#torch.load("albertpair_sind_model_epoch_4_checkpoint_20078.tar", map_location='cpu')
    if CHECKPOINT:
