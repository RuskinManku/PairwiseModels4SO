...
from BERTPair import pair_wise_model

#from ALBERTPair import pair_wise_model

#from EnsemblePair import pair_wise_model
...
def main():
    ...
    checkpoint=torch.load("weights/ensemblepair_sind_model_epoch_2_checkpoint_5.tar")
    ...
    for i in range(test_paragraphs.shape[0]):
        ...
        with torch.no_grad():
            output_logits,batch_index_to_pair_dict=pair_model(test_paragraph_model)
