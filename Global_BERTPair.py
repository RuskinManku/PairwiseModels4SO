...
def main():
    ...
    if args.dataset=="sind":
        ...
        MODEL_SAVE_NAME="global-bertpair_sind_model"
    ...
    CHECKPOINT=None#torch.load("global-bertpair_sind_model_epoch_2_checkpoint_20078.tar", map_location='cpu')
    if CHECKPOINT:
